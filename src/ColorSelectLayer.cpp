...
ColorSelectLayer* ColorSelectLayer::create(EditPopup* popup, const int colorIndex) {
    ColorSelectLayer* ret = new ColorSelectLayer();

    ret->m_popup = popup;
    ret->m_colorIndex = colorIndex;
